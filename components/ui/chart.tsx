...
type ChartTooltipValue = RechartsValueType
type ChartTooltipName = RechartsNameType
type ChartTooltipItem = RechartsTooltipPayload<ChartTooltipValue, ChartTooltipName>
...
function ChartTooltipContent({
  ...
  nameKey,
  labelKey,
}: RechartsTooltipContentProps<ChartTooltipValue, ChartTooltipName> &
  React.ComponentProps<'div'> & {
    hideLabel?: boolean
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-1.5">
        {payloadItems.map((item: ChartTooltipItem, index: number) => {
