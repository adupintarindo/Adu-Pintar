  ...
  return (
    <div className="relative">
      <section className="relative overflow-hidden bg-linear-to-b from-primary/10 via-white to-white dark:via-background dark:to-background">
        ...
        <article className="rounded-3xl border border-white/60 dark:border-white/10 bg-linear-to-br from-white via-primary/10 to-teal-50/80 dark:from-white/5 dark:via-primary/10 dark:to-teal-950/30 p-8 shadow-[0_35px_80px_rgba(15,23,42,0.08)]">
